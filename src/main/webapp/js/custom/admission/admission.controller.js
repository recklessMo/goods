(function () {
    ...
    AdmissionController.$inject = ['$scope', 'AccountService', 'SweetAlert', 'NgTableParams', 'ngDialog', 'blockUI', 'Notify'];

    function AdmissionController($scope, AccountService, SweetAlert, NgTableParams, ngDialog, blockUI, Notify) {
