(function () {
    ...
    ResultRankController.$inject = ['$scope', 'ScoreService', 'DicService', 'ExamService', 'SweetAlert', 'NgTableParams', 'ngDialog', 'blockUI', 'Notify'];

    function ResultRankController($scope, ScoreService, DicService, ExamService, SweetAlert, NgTableParams, ngDialog, blockUI, Notify) {
