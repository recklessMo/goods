(function () {
    ...
    AddOrgController.$inject = ['$scope', 'OrgService','DicService', 'SweetAlert', 'blockUI', 'ngDialog'];

    function AddOrgController($scope, OrgService, DicService,SweetAlert, blockUI, ngDialog) {

        var block = blockUI.instances.get("add-org");
