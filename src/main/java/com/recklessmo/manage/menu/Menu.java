...
//            new Menu(null, "教师站", "ROLE_USER", "icon-book-open", "app.stock-worktable", 2),
...
//            new Menu("教务站", "批量修改", "ROLE_USER", "icon-user-follow", "app.student-edit-worktable", 6),
            ...
            new Menu("成绩站", "考试设置", "ROLE_USER", "icon-plus", "app.exam", 1),
            //成绩分析可以包括单校分析和多校联合对比分析(亮点),多tab. 适用于多学校联考
            new Menu("成绩站", "分析模版", "ROLE_USER", "icon-plus", "app.analyze-template", 2),
            new Menu("成绩站", "成绩分析", "ROLE_USER", "icon-plus", "app.analyze-score", 3),
