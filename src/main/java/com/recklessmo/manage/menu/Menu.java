...
public class Menu{
    ...
    public static Menu[] menuList = {
            new Menu(100, null, "教务站", "#edu", null),
            new Menu(200, null, "成绩站", "#score", null),
//            new Menu(300, null, "统计站", "icon-book-open", null),
            new Menu(400, null, "库存站", "#stock", null),
            new Menu(500, null, "微信站", "#wechat", null),
//            new Menu(600, null, "财务站", "icon-settings", null),
//            new Menu(700, null, "个人中心", "icon-info", null),
            new Menu(800, null, "管理站", "#admin", null),
            new Menu(10000, null, "超管站", "#admin", null),


            new Menu(101, "教务站", "学生查询", "#searchStudent", "app.student-view-worktable"),
            //选择考试, 然后进行成绩趋势分析
//            new Menu(102, "教务站", "个人成绩趋势", "icon-user-follow", "app.student-score-trend"),
            new Menu(103, "教务站", "录入导出", "#importExport", "app.student-add-worktable"),
...
//            new Menu(106, "教务站", "课表编排", "icon-user-follow", "app.class-schedule"),
            ...
            new Menu(201, "成绩站", "考试设置", "#score", "app.exam"),//done
//            new Menu(202, "成绩站", "分析模版", "icon-plus", "app.analyze-template"),
            //成绩单点击可以写评语. 评语跟随成绩
            new Menu(203, "成绩站", "成绩单生成", "#score", "app.result-list"),//half-done
            //雷达图
            new Menu(204, "成绩站", "整体情况分析", "#score", "app.result-total"),//done
            new Menu(205, "成绩站", "分数段分析", "#score", "app.result-gap"),//done
            new Menu(206, "成绩站", "名次构成分析", "#score", "app.result-rank"),//done
            new Menu(207, "成绩站", "进退步分析", "#score", "app.result-rankchange"),
            new Menu(208, "成绩站", "成绩趋势分析", "#score", "app.result-trend"),
            new Menu(209, "成绩站", "单次成绩对比", "#score", "app.result-self"),
            new Menu(210, "成绩站", "综合成绩对比", "#score", "app.result-contrast"),
            new Menu(211, "成绩站", "缺考人员统计", "#score", "app.result-absense"),
...
//            new Menu(304, "统计站", "成本统计", "icon-wallet", "app.wechatStat"),
            ...
            new Menu(401, "库存站", "物资", "#goods", "app.item"),
            new Menu(402, "库存站", "出入库", "#stockList", "app.stock-worktable"),

            new Menu(501, "微信站", "微信咨询", "#talk", "app.wechat-talk"),
            new Menu(502, "微信站", "微信通知", "#notice", "app.wechat-notice"),
            new Menu(503, "微信站", "作业布置", "#assignment", "app.assignment"),
...
//            new Menu(702, "个人中心", "我的课表", "icon-info", "app.account"),
            ...
            new Menu(801, "管理站", "帐号管理", "#account", "app.account"),
            new Menu(802, "管理站", "教务设置", "#eduSetting", "app.edu-setting"),
